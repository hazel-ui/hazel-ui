...
This is a collection of examples of reusable React components.
Browse example stories by navigating to them in the sidebar.

View their code in the `src/package` directory to learn how they work.
We recommend building UIs with a [**component-driven**](https://componentdriven.org) process starting with atomic components and ending with pages.

<br />
<h3 class="subheading">Configure</h3>
