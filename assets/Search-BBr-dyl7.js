...
`;kr.__docgenInfo={description:"",methods:[],displayName:"Control"};function Nr({children:t,...e}){const r=["IndicatorSeparator","DropdownIndicator"],o=m.Children.map(t,n=>n&&!r.includes(n.type.name)?n:null);return w.jsx(Ue.IndicatorsContainer,{...e,children:o})}Nr.__docgenInfo={description:"",methods:[],displayName:"IndicatorsContainer"};function $r(t){const{noOptionsTitle:e,setInvalidSearch:r}=t.selectProps;return m.useEffect(()=>(r(!0),()=>r(!1)),[r]),w.jsxs(w.Fragment,{children:[w.jsx(no,{variant:"label",sx:{fontWeight:"bold",marginTop:"1rem",textAlign:"center"},children:e}),w.jsx(Ue.NoOptionsMessage,{...t})]})}$r.__docgenInfo={description:"",methods:[],displayName:"NoOptionsMessage"};const Js=(t,e)=>({...t,backgroundColor:e.isFocused?U.gray5:e.theme.colors.neutral0,border:`0.1rem solid ${e.theme.colors.neutral30}`,borderRadius:"0.3rem",boxShadow:e.isFocused?ro.xs:"none",cursor:"pointer",height:"3.2rem"}),Zs=(t,e)=>({...t,"::-webkit-scrollbar":{width:"0.6rem"},"::-webkit-scrollbar-thumb":{background:e.theme.colors.primary25,borderRadius:"1rem",boxShadow:"inset 0 0 0.6rem rgba(0, 0, 0, 0.2)"},"::-webkit-scrollbar-thumb:hover":{background:U.gray8},"::-webkit-scrollbar-track":{background:"rgba(0, 0, 0, 0)",borderRadius:"1rem"},maxHeight:"15rem",padding:"0px"}),el=t=>({...t,zIndex:2}),tl=t=>({...t,color:U.gray11,fontFamily:ft.font.sansSerif,marginBottom:"0.5rem"}),nl=(t,e)=>({...t,"&:hover":{boxShadow:`4px 0px 0px 0px ${e.theme.colors.primary25} inset`},"&:nth-of-type(even)":{backgroundColor:e.theme.colors.neutral5},"&:nth-of-type(odd)":{backgroundColor:e.theme.colors.neutral0},alignItems:"center",boxShadow:e.isFocused||e.isSelected?`4px 0px 0px 0px ${e.theme.colors.primary25} inset`:"none",color:U.gray11,cursor:"pointer",display:"flex",fontFamily:ft.font.sansSerif,fontSize:"1rem",height:"3rem",transition:"0.3s ease box-shadow"}),rl=(t,e)=>({...t,fontFamily:ft.font.sansSerif}),ol=t=>({...t,top:"0.4rem"});function he(t){const{floatingLabel:e="Search",noOptionsTitle:r="Invalid search",autoFocus:o=!1,backspaceRemovesValue:n=!0,captureMenuScroll:i=!1,hideSelectedOptions:s=!0,isClearable:l=!0,isLoading:a=!1,isSearchable:u=!0,noOptionsMessage:c=()=>"No results found for this search",placeholder:d="",defaultValue:g,...y}=t,[b,v]=m.useState(!1);return w.jsx(Ys,{floatingLabel:e,invalidSearch:b,setInvalidSearch:v,noOptionsTitle:r,components:{ClearIndicator:Fr,Control:kr,IndicatorsContainer:Nr,NoOptionsMessage:$r},theme:p=>({...p,colors:{...p.colors,neutral0:U.gray3,neutral20:U.gray9,neutral30:U.gray6,neutral5:U.gray2,neutral50:U.gray10,primary:U.gray2,primary25:U.gray4}}),styles:{control:Js,menu:el,menuList:Zs,noOptionsMessage:tl,option:nl,placeholder:rl,valueContainer:ol},autoFocus:o,backspaceRemovesValue:n,captureMenuScroll:i,hideSelectedOptions:s,isClearable:l,isLoading:a,isSearchable:u,noOptionsMessage:c,placeholder:d,...y})}he.__docgenInfo={description:"",methods:[],displayName:"Search",props:{floatingLabel:{required:!1,tsType:{name:"string"},description:""},noOptionsTitle:{required:!1,tsType:{name:"string"},description:""}},composes:["Props"]};function Ar(){return w.jsx(he,{filterOption:il,options:[{label:"First Entry",value:"entry1"},{label:"Second Entry",value:"entry2"},{label:"Third Entry",value:"entry3"}],onChange:t=>{_e(t?`Selected: ${t.label}`:"Cleared")}})}function il(t,e){const r=t.label.toLowerCase(),o=e.length;if(e=e.toLowerCase(),r.slice(0,o)===e)return!0;const n=r.split(" ");for(const i of n.slice(1))if(i.slice(0,o)===e)return!0;return!1}Ar.__docgenInfo={description:"",methods:[],displayName:"EgFiltering"};function jr(){return w.jsx(he,{options:[{label:"First Entry",value:"entry1"},{label:"Second Entry",value:"entry2"},{label:"Third Entry",value:"entry3"}],isMulti:!0,closeMenuOnSelect:!1})}jr.__docgenInfo={description:"",methods:[],displayName:"EgMultiSelect"};function Hr(){const t=[],[e,r]=m.useState(t);return w.jsx(he,{options:e.length>1?[]:[{label:"First Entry",value:"entry1"},{label:"Second Entry",value:"entry2"},{label:"Third Entry",value:"entry3"}],onChange:o=>{r(o||t)},isMulti:!0,closeMenuOnSelect:!1})}Hr.__docgenInfo={description:"",methods:[],displayName:"EgMultiSelectLimit"};function Br(){return w.jsx(he,{options:[{label:"First Entry",value:"entry1"},{label:"Second Entry",value:"entry2"},{label:"Third Entry is a very very long entry that demonstrate text truncations in case of overflow. Decrease screen width to view truncation.",value:"entry3"}],onChange:t=>{_e(t?`Selected: ${t.label}`:"Cleared")}})}Br.__docgenInfo={description:"",methods:[],displayName:"EgSingleSelect"};function Ur(){return w.jsx(he,{options:[{label:"First Entry",value:"entry1"},{label:"Second Entry",value:"entry2"},{label:"Third Entry",value:"entry3"},{label:"Fourth Entry",value:"entry4"},{label:"Fifth Entry",value:"entry5"},{label:"Sixth Entry",value:"entry6"}],onChange:t=>{_e(t?`Selected: ${t.label}`:"Cleared")},theme:t=>({...t,colors:{...t.colors,neutral0:U.gray3,neutral20:U.gray7,neutral30:U.gray8,neutral5:U.gray4,neutral50:U.gray11,primary:U.blue8,primary25:U.blue6}})})}Ur.__docgenInfo={description:"",methods:[],displayName:"EgTheming"};function Nn(t){const e={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",img:"img",li:"li",p:"p",pre:"pre",ul:"ul",...$n(),...t.components};return w.jsxs(w.Fragment,{children:[w.jsx(Xr,{title:"Atoms/Search",component:he}),`
`,w.jsx(e.h1,{id:"search",children:"Search"}),`
`,w.jsxs(e.p,{children:["This component can be used to render a ",w.jsx(e.code,{children:"<select>"}),` like element styled as a
search box to present the user with a list of options to choose from a
dropdown menu.`]}),`
`,w.jsx(e.p,{children:w.jsx(e.img,{src:"",alt:""})}),`
`,w.jsx(e.h2,{id:"props",children:"Props"}),`
`,w.jsxs(e.p,{children:["The following props are available in addition to ",w.jsx(e.a,{href:"https://react-select.com/props",rel:"nofollow",children:"react-select props"}),"."]}),`
`,w.jsx(qr,{of:he}),`
`,w.jsx(e.h2,{id:"examples",children:"Examples"}),`
`,w.jsxs(e.ul,{children:[`
`,w.jsx(e.li,{children:w.jsx(e.a,{href:"#single-select",children:"Single select"})}),`
`,w.jsx(e.li,{children:w.jsx(e.a,{href:"#multi-select",children:"Multi select"})}),`
`,w.jsx(e.li,{children:w.jsx(e.a,{href:"#multi-select-with-choice-limit",children:"Multi select with choice limit"})}),`
`,w.jsx(e.li,{children:w.jsx(e.a,{href:"#theming",children:"Theming"})}),`
`,w.jsx(e.li,{children:w.jsx(e.a,{href:"#filtering",children:"Filtering"})}),`
`]}),`
`,w.jsx(e.h3,{id:"single-select",children:"Single select"}),`
`,w.jsx(e.pre,{children:w.jsx(e.code,{className:"language-tsx",children:`import { useState } from "react";
...
`,w.jsx(Yn,{}),`
`,w.jsx(e.p,{children:w.jsx(e.img,{src:"",alt:""})}),`
`,w.jsx(e.h3,{id:"multi-select",children:"Multi select"}),`
`,w.jsx(e.pre,{children:w.jsx(e.code,{className:"language-tsx",children:`function Component() {
...
`,w.jsx(jr,{}),`
`,w.jsx(e.p,{children:w.jsx(e.img,{src:"",alt:""})}),`
`,w.jsx(e.h3,{id:"multi-select-with-choice-limit",children:"Multi select with choice limit"}),`
`,w.jsx(e.p,{children:"It's possible to set a limit on the number of options the user is allowed to choose."}),`
`,w.jsx(e.pre,{children:w.jsx(e.code,{className:"language-tsx",children:`function Component() {
  return (
    <Search
      options={
...
`,w.jsx(Hr,{}),`
`,w.jsx(e.p,{children:w.jsx(e.img,{src:"",alt:""})}),`
`,w.jsx(e.h3,{id:"theming",children:"Theming"}),`
`,w.jsx(e.pre,{children:w.jsx(e.code,{className:"language-tsx",children:`<Search
  theme={(theme: any) => ({
    ...theme,
    colors: {
      ...theme.colors,
...
`,w.jsx(Ur,{}),`
`,w.jsx(e.p,{children:w.jsx(e.img,{src:"",alt:""})}),`
`,w.jsx(e.h3,{id:"filtering",children:"Filtering"}),`
`,w.jsx(e.p,{children:`You can modify the logic used to filter search results by passing
...
/>
`})}),`
`,w.jsx(Ar,{})]})}function Tl(t={}){const{wrapper:e}={...$n(),...t.components};return e?w.jsx(e,{...t,children:w.jsx(Nn,{...t})}):Nn(t)}export{Tl as default};
